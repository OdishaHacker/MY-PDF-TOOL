...
const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    title: "Hidden Information in PDFs: What Your Documents Reveal About You",
    description:
      "Discover the surprising amount of personal and corporate data hidden in PDF metadata, and learn how to clean it before sharing files externally.",
    date: "May 28, 2026",
    readTime: "6 min read",
    icon: FileSearch,
    color: "#6D9DC5",
